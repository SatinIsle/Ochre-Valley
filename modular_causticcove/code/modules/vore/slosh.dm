/datum/config_entry/number/vorefootstep_volume //This was copied from game_options.dm in the Chompers Code, but it's only ever used here, so I put it in here instead of editing that file.
	default = 75
